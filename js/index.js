jQuery(document).ready(function(e) {
  ...
  feelingthis('chock');
  setTimeout(function(){feelingthis('checkright');},400);
  setTimeout(function(){feelingthis('checkleft');},800);
  setTimeout(function(){feelingthis('satisfied');},1200);
  setTimeout(function(){feelingthis('giggling');},1500);
  setTimeout(function(){feelingthis('satisfied');},2800);
});
...
function feelingthis (emotion) {
  jQuery('#eyes').removeClass();
    ...
    switch (emotion) {
      ...
      case 'hal9000' :
          TweenMax.to(jQuery('#left'), 0.1, {
            css: { height:'10px',top:'50px',width:'10px',borderRadius:'10px',position:'absolute',boxShadow:'0 0 15px #ffbf00',left:'84px',zIndex: '1' }
          });
          TweenMax.to(jQuery('#left hr'), 0.1, {
            css: { borderBottom:'1px solid #ffbf00',borderTop:'1px solid rgba(255, 191, 0, 0.51)' }
          });
          TweenMax.to(jQuery('#right'), 0.1, {
            css: { height:'40px',top:'34px',width:'40px',borderRadius:'50px',position:'absolute',boxShadow:'0 0 15px #ff0007',left:'69px',zIndex: '0' }
          });
          TweenMax.to(jQuery('#right hr'), 0.1, {
            css: { borderBottom:'1px solid #ff0007',borderTop:'1px solid rgba(255, 60, 65, 0.6)' }
          });
          TweenMax.to(jQuery('.lowereyelid'), 0.1, {
      ...
      case 'satisfied' :
        ...
        TweenMax.to(jQuery('#right'), 0.2, {
          css: { top: '-20px', height: '20px', borderTopRightRadius: '30px', borderTopLeftRadius: '30px'}
        });
